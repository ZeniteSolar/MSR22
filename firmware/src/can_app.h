...
void can_app_send_adc_0(void);
void can_app_send_adc_1(void);
...
#ifdef CAN_ON
#define CAN_APP_SEND_STATE_CLK_DIV  (MACHINE_FREQUENCY/CAN_APP_SEND_STATE_FREQ)
#define CAN_APP_SEND_ADC_CLK_DIV    (MACHINE_FREQUENCY/CAN_APP_SEND_ADC_FREQ)
#else
